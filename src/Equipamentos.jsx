  ...
  return (
    <div className="container-details">
      ...
      <div className="card-details">
        ...
        <p className="card-description details-description">
          {produto.descricao}
        </p>
  ...
  const todosProdutos = [
    {
      ...
      specs: [
        ...
        "Conexão Bluetooth e Cabo",
        "Bateria de 4000mAh",
      ],
      ergonomia:
        "Teclas com resposta tátil leve e altura reduzida, prevenindo a fadiga do pulso em digitações prolongadas.",
    },
    {
      id: 2,
      categoria: "Monitores",
      ...
      foto: foto2,
      specs: [
        "Resolução WQHD (3440x1440)",
        "Painel IPS 144Hz",
        "Suporte com Ajuste de Altura",
      ],
      ergonomia:
        "Área de tela estendida que elimina a necessidade de um segundo monitor, reduzindo o movimento excessivo do pescoço.",
    },
    {
      id: 3,
      categoria: "Ergonomia",
      ...
      descricao:
        "Suporte lombar avançado e estrutura ajustável de alta durabilidade.",
      preco: "R$12.490,00",
      foto: foto3,
      specs: [
        "Ajuste Lombar PostureFit",
        "Malha Mesh Respirável",
        "Braços Reguláveis 3D",
      ],
      ergonomia:
        "Distribuição uniforme do peso corporal e alinhamento natural da coluna vertebral durante todo o expediente.",
    },
    {
      id: 4,
      categoria: "Periféricos",
      ...
      specs: [
        "Sensor 8000 DPI",
        "Clique Silencioso",
        "Scroller MagSpeed em Aço",
      ],
      ergonomia:
        "Design esculpido para encaixe perfeito da mão, mantendo o pulso em um ângulo neutro e natural.",
    },
    {
      id: 5,
      categoria: "Monitores",
      ...
      specs: [
        "Resolução 4K UHD",
        "Conectividade USB-C 65W",
        "Rotação de 90° (Modo Pivot)",
      ],
      ergonomia:
        "Rotação vertical perfeita para leitura de linhas extensas de código mantendo a postura ereta.",
    },
    {
      id: 6,
      categoria: "Ergonomia",
      ...
      descricao:
        "Ajuste fluido de altura, inclinação e rotação 360° para alinhamento postural.",
      preco: "R$199,00",
      ...
      specs: [
        "Pistão a Gás com Amortecimento",
        "Padrão VESA 75x75 e 100x100",
        "Organizador de Cabos Integrado",
      ],
      ergonomia:
        "Posiciona a tela na altura exata da linha dos olhos, eliminando a tensão na cervical e nos ombros.",
    },
    {
      id: 7,
      categoria: "Hardware",
      ...
      descricao:
        "O topo absoluto em desempenho gráfico para IA avançada e renderização 3D extrema.",
      preco: "R$19.999,00",
      ...
      ergonomia:
        "Aceleração gráfica de última geração que elimina gargalos, otimizando o fluxo de trabalho e o tempo de resposta.",
    },
    {
      id: 8,
      categoria: "Hardware",
      ...
      descricao:
        "O processador mais potente do mercado para compilação pesada e multitarefa.",
      preco: "R$4.599,00",
      foto: "https://m.media-amazon.com/images/I/71hZfMZNZuL._AC_SY300_SX300_QL70_ML2_.jpg",
      specs: [
        "16 Cores e 32 Threads",
        "Clock Boost até 5.7GHz",
        "80MB de Cache Total",
        "Socket AM5",
      ],
      ergonomia:
        "Fluidez em multitarefa extrema que impede travamentos do sistema, reduzindo a fadiga durante a rotina dev.",
    },
  ];
      ...
      <div className="container">
        <header className="header-box">
          ...
          <p className="description">
            Aprenda a configurar seu ambiente de trabalho para evitar lesões e
